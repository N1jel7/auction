...
public class BuyersController {
    ...
    @FXML
    private TableColumn<LotResponseDto, String> buyerFullnameColumn;

    @FXML
    private TableColumn<LotResponseDto, String> purchasedAtColumn;
    ...
    public void initialize() {
        ...
        stage = new Stage();
        stage.setScene(new Scene(buyersView));
        ...
        buyerFullnameColumn.setCellValueFactory(lot -> new ReadOnlyObjectWrapper<>(lot.getValue().buyerFullname()));
        purchasedAtColumn.setCellValueFactory(lot -> new ReadOnlyObjectWrapper<>(formatDate(lot.getValue().soldAt())));
